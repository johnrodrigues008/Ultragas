function formsB(){let e=document.querySelector(".et_pb_section.et_pb_section_1.et_pb_with_background.et_section_regular"),o=/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent);(e=o?document.querySelector(".et_pb_section.et_pb_section_2.et_pb_with_background.et_section_regular"):document.querySelector(".et_pb_section.et_pb_section_1.et_pb_with_background.et_section_regular")).innerHTML=`
...
<path d="m13.05 24.637c2.4206 0 4.7869-0.7178 6.7995-2.0626 2.0127-1.3448 3.5814-3.2563 4.5077-5.4926 0.9263-2.2364 1.1687-4.6972 0.6964-7.0713-0.4722-2.3741-1.6378-4.5548-3.3495-6.2664-1.7116-1.7116-3.8923-2.8773-6.2664-3.3495-2.3741-0.47224-4.8349-0.22987-7.0713 0.69646-2.2364 0.92633-4.1478 2.495-5.4926 4.5077-1.3448 2.0127-2.0626 4.3789-2.0626 6.7995 0 3.2459 1.2894 6.3589 3.5847 8.6541 2.2952 2.2953 5.4082 3.5847 8.6542 3.5847zm-1.5776-19.215 6.9761 7.0569-6.9895 6.9088-1.7135-1.7404 5.2492-5.1917-5.2626-5.3202 1.7403-1.7134z" fill="#fff"/>
  ...
  `,document.body.classList.add("optimize"),function e(){let o=document.querySelector("form.rck-box-form"),_=document.querySelector("form.rck-box-form-next"),i=o.querySelector("#wpforms-651-field_1"),l=o.querySelector("#wpforms-651-field_2"),a=o.querySelector("#wpforms-651-field_3"),s=o.querySelector("#wpforms-651-field_35"),$=o.querySelector("#wpforms-651-field_11_1"),r=o.querySelector("#wpforms-651-field_11_2"),t=_.querySelector("#wpforms-651-field_34"),n=_.querySelector("#wpforms-651-field_6"),d=_.querySelector("#wpforms-651-field_16"),p=_.querySelector("#wpforms-651-field_18_1"),c=_.querySelector("#wpforms-651-field_29_1"),f=_.querySelector("#rck-next-enviar"),m=document.querySelector("form#wpforms-form-651");(function e(o,_){o.forEach(function(e){e.addEventListener("input",function(){_[e.id].value=e.value})})})([i,l,a,s,$,r,p,c],m),function e(o,_){o.forEach(function(e){e.addEventListener("change",function(){_[e.id].value=e.value})})}([t,n,d],m);document.querySelector("#AnexaLuz").addEventListener("click",()=>{document.querySelector("#wpforms-651-field_39-container .wpforms-uploader.dz-clickable").click()});document.querySelector("#AnexaIde").addEventListener("click",()=>{document.querySelector("#wpforms-651-field_40-container .wpforms-uploader.dz-clickable").click()});let u=document.getElementById("rck-next");function v(){""!==i.value&&""!==l.value&&""!==a.value&&""!==s.value&&($.checked||r.checked)?(u.disabled=!1,u.addEventListener("click",()=>{document.getElementById("rck-box-form").style.display="none",document.getElementById("rck-box-form-next").style.display="flex"})):u.disabled=!0}i.addEventListener("input",v),l.addEventListener("input",v),a.addEventListener("input",v),s.addEventListener("input",v),$.addEventListener("change",v),r.addEventListener("change",v);document.getElementById("rck-prev").addEventListener("click",()=>{document.getElementById("rck-box-form-next").style.display="none",document.getElementById("rck-box-form").style.display="flex"}),f.addEventListener("click",function(){m.submit()})}()}window.addEventListener("DOMContentLoaded",formsB());